...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- je crois que je pourrais mettre ça dans vim.list_extend(ensured_installed...
  ...
  },
  {
    ...
    event = {
      ...
      'BufReadPre /home/rodgeur/notes/*.md',
      'BufNewFile /home/rodgeur/notes/*.md',
    },
    dependencies = {
      -- Required.
      'nvim-lua/plenary.nvim',
